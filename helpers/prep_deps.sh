...
#test -d python-trezor || git clone https://github.com/creditbit/python-trezor
...
# Build docker images
$DOCKERBIN images|awk '{print $1":"$2}'|grep "creditbit/electrum-creditbit-winbuild:${VERSION}" || buildImage winbuild
$DOCKERBIN images|awk '{print $1":"$2}'|grep "creditbit/electrum-creditbit-release:${VERSION}" || buildImage release
