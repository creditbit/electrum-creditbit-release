...
Section
  ...
  CreateShortCut "$DESKTOP\Encompass.lnk" "$INSTDIR\electrum-creditbit.exe" ""
  ...
  CreateShortCut "$SMPROGRAMS\Encompass\Encompass.lnk" "$INSTDIR\electrum-creditbit.exe" "" "$INSTDIR\electrum-creditbit.exe" 0
